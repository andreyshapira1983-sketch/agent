...
GROUPS: list[tuple[str, str, list[str]]] = [
    ...
    ("Cognitive Core & Agent Cycle (§3)", "Planning, verification, clarification, control loop.", [
        ...
        "evidence_support", "confidence_vector", "relevance_judge", "draft_refutation", "patch_route", "note_contract", "defect_intake", "stuck_route",
    ...
    ("Memory & Knowledge Governance (§4)", "Working/persistent memory, hygiene, ingestion, evidence.", [
        ...
        "learned_conclusion", "cache_freshness",
    ...
    ("Runtime, State & Orchestration (§6)", "Autonomous loop, scheduling, budgets, state durability.", [
        "capability_events",
        "autonomous_runtime", "autonomous_runtime_proposals", "autonomous_runtime_types", "scheduler", "campaign", "campaign_io", "campaign_ledger", "drives", "drive_goal",
