...
# work outranks the advisory anatomy follow-up list.
_SOURCE_BASE_SCORE = {"tech_debt": 2.0, "anatomy": 1.0}
_SOURCE_CONFIDENCE = {"tech_debt": 0.7, "anatomy": 0.5}
_PENALTY_SCORE = 1.0
...
def build_backlog(
    *,
    ...
    records = open_tech_debt(tech_debt_text) + anatomy_candidates(anatomy_text)
    sources = {"tech_debt": tech_debt_text, "anatomy": anatomy_text}
