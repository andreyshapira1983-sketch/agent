...
class CognitiveCore:
    ...
    def plan(self, goal):
        ...
        prompt = (
            ...
            "  CONTENT обязан содержать ПОЛНЫЙ рабочий исходный код — весь файл целиком.\n"
            "  Реальный файл = import-ы, классы, функции, docstring, if __name__ == '__main__'.\n"
            "  Нормальный модуль — это 50-300 строк (1000-10000+ символов), а не 10 строк.\n"
            "  ЗАПРЕЩЕНО: 'код выше', 'см. выше', заглушки, описания, pass, TODO, '...', пустые блоки.\n"
            "  Вставляй весь код прямо в CONTENT — без markdown-обёрток ``` внутри CONTENT.\n"
            "  Файлы короче 200 символов АВТОМАТИЧЕСКИ ОТКЛОНЯЮТСЯ — пиши полноценный код сразу.\n"
            ...
            "- ЗАПРЕЩЕНО в ```python блоках: exec(), eval(), compile(), getattr(), setattr(), "
            "globals(), locals(), __import__(). Эти вызовы БЛОКИРУЮТСЯ песочницей — код не выполнится.\n"
