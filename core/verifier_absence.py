...
Presence is proved by a line; absence is not. Everything here exists to keep
"X does not appear in Y" from being either waved through on a resolvable
citation or refused merely because nothing can be quoted.
"""
