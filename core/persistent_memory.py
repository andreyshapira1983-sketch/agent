...
# Дверь записи самого агента (его словарь, его отказы) — в core/memory_door.py.
# Имена реэкспортируются: инструмент memory_bank и тесты берут их отсюда.
from core.memory_door import (  # noqa: F401
    ACCEPTED_KINDS_TEXT,
    CONSENT_TAG_MAP,
    _looks_like_code,
    memory_door_verdict,
