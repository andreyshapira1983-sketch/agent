...
# Фильтр ЧТЕНИЯ «знание о себе — не в предметную задачу» (звено 5) живёт в
# core/self_knowledge.py; имена реэкспортируются для прежних импортов.
from core.self_knowledge import (  # noqa: F401
    asks_about_self,
    is_self_knowledge,
    self_knowledge_off_topic,
)
