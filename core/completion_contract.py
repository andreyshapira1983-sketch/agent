...
#: стоит НЕ в поручении, а в рассказе или условии. Корень глубже заплат:
#: действие вычитывается из вольной прозы, где глагол письма живёт и вне
#: приказа. Настоящее лекарство — считать глагол поручением только рядом
#: с путём; оно не сделано, и это записано здесь честно.
