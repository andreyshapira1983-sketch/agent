...
| **How well the five observational sensors actually signal** | [audit/SENSOR_SIGNAL_MEASUREMENT.md](audit/SENSOR_SIGNAL_MEASUREMENT.md) | measured accuracy, signal uniqueness and connect-cost per sensor — **numbers only, it classifies nothing** | whether any sensor should be connected, kept or removed (operator's decision, `COGNITIVE_CORE.md` §12) |
