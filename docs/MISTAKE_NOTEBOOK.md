...
| 2 | [core/state_integrity.py:49](../core/state_integrity.py#L49) | episodes are written wrapped in `{_integrity, payload}` — a top-level search returns a false zero | assistant, 2026-08-04 | reading trap, not a defect |
