...
| 6 | [core/autonomous_runtime.py:762](../core/autonomous_runtime.py#L762) | the autonomous test report carries the fingerprint | assistant, 2026-08-04 | PR #302 |
...
| 28 | [core/self_build_producer.py:110](../core/self_build_producer.py#L110) | the 16 000-token ceiling is PER LEG, not per answer: auto-continuation could stretch it to five legs (a live reply hit 20 509) | assistant, 2026-08-04 | MIR-084 |
| 20 | [core/loop_attempt.py:580](../core/loop_attempt.py#L580) | the `@staticmethod` that an AST `lineno` cut left behind — restored here, and the whole move is now compared decorator by decorator | assistant, 2026-08-04 | this change |
...
| 21 | [tests/test_loop_split_wiring.py:115](../tests/test_loop_split_wiring.py#L115) | `if TYPE_CHECKING` host contracts were checked by nobody — two mixins declared fields they never touch | assistant, 2026-08-04 | this change |
...
| 26 | [tests/test_task_claim_is_exclusive.py:11](../tests/test_task_claim_is_exclusive.py#L11) | `except Exception: continue  # another process already claimed it` — a guard for an exception nobody raised; the guard itself was removed with the MIR-081 fix, so the address now points at the test that keeps the lesson | assistant, 2026-08-04 | MIR-081 |
...
| 27 | [core/autonomous_runtime.py:1014](../core/autonomous_runtime.py#L1014) | the branch that makes the agent study its weak spots had no test at all | coverage, 2026-08-04 | MIR-082 |
...
| 30 | [core/memory_policy.py:332](../core/memory_policy.py#L332) | recall scored Russian questions against English records by word overlap: «кто владеет архитектурой?» 0 records, the English form 3 | assistant, 2026-08-04 | MIR-086 |
