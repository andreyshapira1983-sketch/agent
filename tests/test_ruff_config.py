...
_BASELINE_FINDINGS = 87  # 779 → … → 136 → 113 → 114 → 115 → 116 → 118 → 120 → 87. −33 (2026-09-24): тест молча не шёл на сервере (ruff не стоял), долг дорос до 129; 42 новых замечания с 18.09 закрыты, база опущена, чтобы выигрыш нельзя было проесть обратно. +1 (2026-08-29): PLR0911 в
