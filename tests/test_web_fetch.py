...
def test_space_only_lines_do_not_eat_the_window():
    ...
    body = b"<div>\n \n \n  \n<p>Released:</p>\n \n \n<p>Sep 15, 2026</p>\n \n</div>"
    out = WebFetchTool(opener=_opener_with(body, content_type="text/html")).run(url="https://example.com/")
    assert "\n \n" not in out["text"] and "Released:" in out["text"] and "Sep 15, 2026" in out["text"]
