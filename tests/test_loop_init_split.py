...
#: 2026-09-19: `observe_before_answer` — после успешного пакета шагов ещё круг
#: планирования с увиденным (core/observation_round.py). Тоже В ХВОСТЕ, по
#: умолчанию выключено, поэтому прежние вызовы не меняют смысла.
_DECLARED_ADDED_PARAMS = ("pending_clarification_path", "causal_store", "observe_before_answer")
