...
# действительно уменьшился. Поведение самих обработчиков теперь пинит
# `tests/test_run_tail_failures_are_reported.py` — он красный на старом коде
# (2 из 9), что дословная сверка показать не могла в принципе.
#
