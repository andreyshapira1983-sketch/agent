...
WATCH: dict[str, int] = {
    ...
    "core/evidence.py:evidence_from_tool_result": 324,  # +3 (2026-09-19, опыт с библиотекой книг): улика find_in_files — выдача поиска как tool_output с сырым текстом, а не repr() строки в запасной ветке.
