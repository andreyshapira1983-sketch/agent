...
WATCH: dict[str, int] = {
    ...
    "core/loop_attempt.py:AgentLoopAttempt._run_attempt_loop": 442,  # +3 (2026-09-20): журнал называет, чем судили согласованность (довод шага или запасной словарь) и сколько шагов пришли с доводом — иначе два способа неотличимы в записях.  # +1 (2026-09-20): датчик согласованности судит по доводу ШАГА, когда план его несёт; словарь по прозе остался запасным путём.
