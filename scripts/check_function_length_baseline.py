...
WATCH: dict[str, int] = {
    ...
    "core/loop.py:AgentLoop._run_inner": 431,  # +1 (2026-09-19 web exam): the failure history reaches the response draft, so a turn stuck on its own draft's citations does not ask the human «what to build».  # +2 (2026-09-04 exam, turn 3: the sensor blocks folded into the evidence chain).  # +1 (2026-09-04 exam, turn 2: the spend/roster block now reaches the synthesizer through SynthesisState).  # замер 417 (2213 до раскола) + запас 10
