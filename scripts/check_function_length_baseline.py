...
WATCH: dict[str, int] = {
    ...
    "app/bootstrap.py:build_agent": 256,  # +2 (2026-08-31): регистрация memory_bank — банка памяти агента (решение и подпись — агента, ratchet_entry.md).  # +2 (2026-08-17): регистрация lesson_provenance — прибора причинного происхождения уроков.  # +2 (2026-08-16): регистрация python_probe — лаборатории замера собственной среды.  # 246 -> 250 (2026-08-15): импорт, создание и передача causal_store — без него наблюдение не переживало ход (MIR-096).
