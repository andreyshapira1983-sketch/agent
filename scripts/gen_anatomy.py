...
GROUPS: list[tuple[str, str, list[str]]] = [
    ...
    ("Cognitive Core & Agent Cycle (§3)", "Planning, verification, clarification, control loop.", [
        ...
        "planner", "causal_store", "causal_climb", "causal_claim_store", "placeholder_text", "planner_prompt", "plan_parsing", "doc_routing", "host_tools_context", "step_sanitizer", "verifier", "verifier_core", "verifier_models", "verifier_patterns", "verification_summary", "sensor_journal",
    ...
    ("Model Management (§6 / §12)", "Model discovery, routing, usage accounting.", [
        ...
        "model_registry_audit", "degraded_route", "model_outcomes",
    ]),
