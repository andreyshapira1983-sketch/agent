...
GROUPS: list[tuple[str, str, list[str]]] = [
    ...
    ("Cognitive Core & Agent Cycle (§3)", "Planning, verification, clarification, control loop.", [
        ...
        "planner", "causal_store", "causal_climb", "placeholder_text", "planner_prompt", "plan_parsing", "doc_routing", "host_tools_context", "step_sanitizer", "verifier", "verifier_core", "verifier_models", "verifier_patterns", "verification_summary", "sensor_journal",
