...
WATCH: dict[str, int] = {
    "core/loop.py": 4232,                  # was 4500; decomposition banked 4047; MIR-077 УМЕНЬШИЛ файл: логика сбоя сенсоров вынесена в core/sensor_journal, в цикле остались вызовы
