...
def run_bot(
    ...
    *,
    ...
    """Run Telegram bot with long polling. Optional: /status, /quality, /reset_quality, /log, /tasks, /mood, /autonomous, /stop, /safe_expand, /apply_sandbox_only, /guard, /help, /cancel, /remind."""
