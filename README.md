...
### Стабильность слоёв (по живым прогонам, 361 лог, 25 мая – 4 июня)

| Слой (task kind) | Прогонов | Стабильность | Примечание |
| --- | --- | --- | --- |
| `status` | 72 | **100%** | — |
| `propose` | 7 | **100%** | новый слой, данных мало |
| `tests` | 45 | **95.6%** | сбои — не свои баги |
| `learn` | 51 | **92.2%** | skipped = бюджет, не ошибка |
| `goal` | 4 | 75% | мало прогонов для оценки |
