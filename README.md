...
3. Pick LLM provider via env vars:
   ...
   today: `anthropic`, `openai`, `huggingface`, and `mock`.
...
What is covered today (**1435 tests, ≈ 18 s, zero network calls**):
