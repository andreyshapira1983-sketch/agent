...
A hermetic test suite (**1357 cases, zero network**) backs every layer:
...
- **Interactive** (no `--ask`) — a session with Working Memory **and**
  ...
  `:hygiene`, `:rollback`, `:help`, `:quit` for control.
...
> 1357 hermetic tests covering every production module, and
...
What is covered today (**1357 tests, ≈ 27 s, zero network calls**):
